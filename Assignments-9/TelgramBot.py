...
def random_photo(message):
    bot.send_message(message.chat.id, "It may take a few moments...")
    file = "C:/Users/AmirrezA/Pictures/Saved Pictures/"
    random_photo = random.randint(1,71)
    photo_random = str(random_photo)
    photo_selected = file + photo_random + ".jpg"
    photo = open(photo_selected, "rb")
    bot.send_photo(message.chat.id, photo)
    bot.send_message(message.chat.id, "here your random photo.")
